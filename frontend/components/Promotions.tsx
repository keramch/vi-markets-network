      ...
      <div className="space-y-12">
        {ownedMarket && (
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold font-serif text-brand-blue mb-2">For Your Market: <span className="text-brand-light-blue">{ownedMarket.name}</span></h2>
        ...
        {ownedVendor && (
           <div className="bg-white p-8 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold font-serif text-brand-blue mb-2">For Your Business: <span className="text-brand-light-blue">{ownedVendor.name}</span></h2>
