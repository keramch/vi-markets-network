  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white p-8 rounded-lg shadow-xl">
        ...
        <h2 className="text-3xl font-bold font-serif text-brand-blue mb-2">{isMarket(formData) ? 'Market Hub' : 'Vendor Hub'}</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {activeTab === 'reviews' && (
                 <div>
                    <h2 className="text-2xl font-bold font-serif text-brand-blue mb-4">Review Moderation</h2>
