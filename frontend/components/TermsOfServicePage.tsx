  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <h1 className="text-4xl font-serif text-brand-blue mb-6">Terms of Service</h1>
        <div className="prose max-w-none text-brand-text">
            ...
            <h2 className="text-2xl font-serif text-brand-blue mt-8">1. Acceptance of Terms</h2>
            ...
            <h2 className="text-2xl font-serif text-brand-blue mt-8">2. User-Generated Content</h2>
            ...
            <h2 className="text-2xl font-serif text-brand-blue mt-8">3. Prohibited Activities</h2>
            ...
            <h2 className="text-2xl font-serif text-brand-blue mt-8">4. Termination</h2>
            <p>We may terminate or suspend your account and bar access to the Service immediately, without prior notice or liability, under our sole discretion, for any reason whatsoever and without limitation, including but not limited to a breach of the Terms.</p>

            <h2 className="text-2xl font-serif text-brand-blue mt-8">5. Disclaimer</h2>
